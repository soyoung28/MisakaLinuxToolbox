...
```shell
wget -N --no-check-certificate https://raw.githubusercontents.com/soyoung28/MisakaLinuxToolbox/master/MisakaToolbox.sh && bash MisakaToolbox.sh
```
国内特供版：(部分功能**无法使用**)
```shell
wget -N --no-check-certificate https://gitee.com/soyoung28/MisakaLinuxToolbox/raw/master/MisakaToolbox.sh && bash MisakaToolbox.sh
```
